  ...
  return (
    ...
    >
      <body className="min-h-dvh">
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[400] focus:rounded-lg focus:bg-blue focus:px-4 focus:py-2 focus:text-ink"
        >
          Skip to content
        </a>
        {children}
